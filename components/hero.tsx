            ...
            <div className="container mx-auto md:px-48 md:py-10">
                <div className="flex flex-col md:flex-row items-center">
                    <div className="w-full md:w-1/2 mb-8 md:mb-0 md:pr-8 flex flex-col items-center md:text-left">
                        <h1 className="text-7xl font-extrabold leading-tight mb-6 sm:text-7xl md:text-7xl">
                        Hi, I&apos;m Riley
                        </h1>
                        <p className="font-medium mb-6 max-w-3xl mx-auto md:mx-0 leading-relaxed dark:text-gray-300 sm:text-xl text-center">
                        ...
                        <div className="flex flex-wrap items-center md:justify-start gap-6">
                            ...
                            className="transition-all duration-400 hover:brightness-0 hover:invert hover:sepia hover:saturate-[5000%] hover:hue-rotate-[190deg]"></Image></a>
                            <a href="https:/www.linkedin.com/rileyfletcher"><Image src="linkedin.svg" alt="GitHub" width={40} height={40}
                            className="transition-all duration-400 hover:brightness-0 hover:invert hover:sepia hover:saturate-[5000%] hover:hue-rotate-[190deg]"></Image></a>
                            <a href="mailto: nrileyfletcher@gmail.com"><Image src="email.svg" alt="GitHub" width={40} height={40}
                            className="transition-all duration-400 hover:brightness-0 hover:invert hover:sepia  hover:hue-rotate-[190deg]"></Image></a>
                        </div>
                    </div>
