    ...
    return(
        <nav className="py-3 px-4 flex items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <Link className="font-medium text-md px-4 py-2 leading-none rounded-full tracking-tight transition-all duration-700 hover:text-green" href="resume.pdf" download="fletcher_resume">resume</Link>
            </div>
        </nav>
    )
}