    ...
    return (
        <div className="flex flex-col items-center mb-10">
            ...
            <div className="max-w-xl mx-auto space-y-5 mt-10">
                ...
                <p className="sm:text-xl"> 
                    Currently, I am a software engineering intern at Dell Technologies working for the Powerstore team
                    on the backend protocols team. I&apos;m currently working on Python utilities for IO workload automation
                    and reporting, as well as IO tracing and analysis. This role has been super fun so far as I am very
                    interested in gaining more opportunities to work with systems software and hardware appliances.
                </p>
                ...
                <p className="sm:text-xl">
                    ...
                    for the United States Navy, at the Dahlgren research facility. As a part of the CIAT team,
                ...
                <p className="sm:text-xl">
                From the Summer of 2022 to Spring of 2023, I was an information technology intern at Virginia
                Railway Express. As my first &apos;proper&apos; technical role,
