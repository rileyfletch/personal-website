  ...
  return (
    <section id="about" className="py-8 flex flex-col items-center">
      <div className="max-w-4xl">
        <p className="font-bold text-5xl mb-8 mt-16 text-center transition duration-500 hover:text-persian">About Me</p>
        ...
        <p className="text-3xl mb-5 pt-4">
          ...
          className="hover:text-persian transition duration-500 underline underline-offset-4 decoration-green-500 hover:decoration-blue-700">Letterboxd</a> if you want 
